" Sentry Sentinel Dark - Vim Colorscheme
" Author: Sentry
" Description: Beautiful, accessible dark theme inspired by Sentry's brand colors
" Version: 1.0.0
...
let g:colors_name = 'sentinel_dark'
set background=dark

" Sentry Brand Colors
let s:bg_primary     = '#1b1821'
let s:bg_secondary   = '#24202b'
let s:bg_tertiary    = '#2e2936'
